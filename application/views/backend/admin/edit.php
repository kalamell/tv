          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <?=form_open('backend/admin/do_edit');?>
                <input type="hidden" name="admin_id" value="<?=$r->admin_id;?>">
                <input type="hidden" name="old_username" value="<?=$r->username;?>">
				        <div class="box-body">

                  <div class="form-group">
                    <label for="username">Username</label>
                    <input type="text" name="username" class="form-control" id="username" value="<?=$r->username;?>" placeholder="Username">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" id="name" value="<?=$r->name;?>" placeholder="ชื่อ">
                  </div>
